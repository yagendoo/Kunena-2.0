...
class KunenaViewTopic extends KunenaView {
	...
	function getTopicActions() {
		...
		if ($this->topic->authorise('reply')) {
			...
			$this->topicButtons->set('reply', '<a class="btn btn-inverse" href="'.sprintf($layout, 'reply').'" rel="nofollow">'.JText::_('COM_KUNENA_REPLY').'</a>');
		}
		...
		if ($this->usertopic->subscribed) {
			...
			$this->topicButtons->set('subscribe', '<a class="btn" href="'.sprintf($task, 'unsubscribe').'" rel="nofollow">'.JText::_('COM_KUNENA_UNSUBSCRIBE').'</a>');
			...
			$this->topicButtons->set('subscribe', '<a class="btn" href="'.sprintf($task, 'subscribe').'" rel="nofollow">'.JText::_('COM_KUNENA_SUBSCRIBE').'</a>');
		}
		...
		if ($this->usertopic->favorite) {
			...
			$this->topicButtons->set('favorite', '<a class="btn" href="'.sprintf($task, 'unfavorite').'" rel="nofollow">'.JText::_('COM_KUNENA_UNFAVORITE').'</a>');
			...
			$this->topicButtons->set('favorite', '<a class="btn" href="'.sprintf($task, 'favorite').'" rel="nofollow">'.JText::_('COM_KUNENA_FAVORITE').'</a>');
		}
		...
		if ($this->category->authorise('moderate')) {
			...
			*/
			$this->topicButtons->set('sticky', '<a class="btn btn-primary" href="'.sprintf($task, $sticky).'" rel="nofollow">'.JText::_('COM_KUNENA_STICKY').'</a>');
			$this->topicButtons->set('lock', '<a class="btn btn-primary" href="'.sprintf($task, $lock).'" rel="nofollow">'.JText::_('COM_KUNENA_LOCK').'</a>');
			$this->topicButtons->set('moderate', '<a class="btn btn-primary" href="'.sprintf($layout, 'moderate').'" rel="nofollow">'.JText::_('COM_KUNENA_MODERATE_TOPIC').'</a>');
			$this->topicButtons->set('delete', '<a class="btn btn-primary" href="'.sprintf($task, 'delete').'" rel="nofollow">'.JText::_('COM_KUNENA_DELETE_TOPIC').'</a>');
		}
	...
	function getMessageActions() {
		...
		if ($this->message->authorise('reply')) {
			...
			$this->messageButtons->set('reply', '<a class="btn" href="'.sprintf($layout, 'reply').'" rel="nofollow">'.JText::_('COM_KUNENA_REPLY').'</a>');
			$this->messageButtons->set('quote', '<a class="btn" href="'.sprintf($layout, 'reply&quote=1').'" rel="nofollow">'.JText::_('COM_KUNENA_QUOTE').'</a>');
		...
		if ($this->config->reportmsg && $this->me->exists()) {
			...
			$this->messageButtons->set('report', '<a class="btn" href="'.sprintf($layout, 'report').'" rel="nofollow">'.JText::_('COM_KUNENA_REPORT_MODERATOR').'</a>');
		}
		...
		$this->message->authorise('edit') ? $this->messageButtons->set('edit', '<a class="btn btn-primary" href="'.sprintf($layout, 'edit').'" rel="nofollow">'.JText::_('COM_KUNENA_EDIT').'</a>') : null;
		$this->message->authorise('move') ? $this->messageButtons->set('moderate', '<a class="btn btn-primary" href="'.sprintf($layout, 'moderate').'" rel="nofollow">'.JText::_('COM_KUNENA_MODERATE').'</a>') : null;
		...
		if ($this->message->hold == 1) {
			...
			$this->message->authorise('approve') ? $this->messageButtons->set('publish', '<a class="btn" href="'.sprintf($task, 'approve').'" rel="nofollow">'.JText::_('COM_KUNENA_APPROVE').'</a>') : null;
			$this->message->authorise('delete') ? $this->messageButtons->set('delete', '<a class="btn" href="'.sprintf($task, 'delete').'" rel="nofollow">'.JText::_('COM_KUNENA_DELETE').'</a>') : null;
			...
			$this->message->authorise('undelete') ? $this->messageButtons->set('undelete', '<a class="btn" href="'.sprintf($task, 'undelete').'" rel="nofollow">'.JText::_('COM_KUNENA_UNDELETE').'</a>') : null;
			$this->message->authorise('permdelete') ? $this->messageButtons->set('permdelete', '<a class="btn" href="'.sprintf($task, 'permdelete').'" rel="nofollow">'.JText::_('COM_KUNENA_PERM_DELETE').'</a>') : null;
		} else {
			//$this->message->authorise('delete') ? $this->messageButtons->set('delete', $this->getButton ( sprintf($task, 'delete'), 'delete', 'message', 'moderation')) : null;
			$this->message->authorise('delete') ? $this->messageButtons->set('delete', '<a class="btn btn-primary" href="'.sprintf($task, 'delete').'" rel="nofollow">'.JText::_('COM_KUNENA_DELETE').'</a>') : null;
		}
